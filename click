...
(adsbygoogle = window.adsbygoogle || []).push({});
      ...
      <h3>About Bandit Unblocker</h3>
      <p>Bandit Unblocker is a web proxy, similar to CGIProxy, PHProxy, or Glype, that allows users to evade filters and censorship and access blocked websites. </p>
      ...
      <p>Bandit Unblocker is written in JavaScript with <a href="http://nodejs.org">node.js</a>. The source code is <a href="https://github.com/nfriedly/node-unblocker">available on github</a>.</p>
